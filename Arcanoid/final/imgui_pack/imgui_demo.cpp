...
#endif
            ImGui::MenuItem(
                "Metrics/Debugger", NULL, &show_app_metrics, has_debug_tools);
            ImGui::MenuItem(
                "Debug Log", NULL, &show_app_debug_log, has_debug_tools);
            ImGui::MenuItem(
                "Stack Tool", NULL, &show_app_stack_tool, has_debug_tools);
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            if (ImGui::IsItemHovered(
                    ImGuiHoveredFlags_DelayNormal)) // With a delay
                ImGui::SetTooltip("I am a tooltip with a delay.");

            ImGui::SameLine();
            HelpMarker("Tooltip are created by using the IsItemHovered() "
                       "function over any kind of item.");
        }
